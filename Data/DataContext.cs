    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Effect>().HasData(
                ...
                new Effect {Id = 8, Name = "Lethargy", Intensity = -15, Self = false, Duration = 1},
                new Effect {Id = 9, Name = "Wisdom", Intensity = 15, Self = true, Duration = -1},
                new Effect {Id = 10, Name = "Folly", Intensity = -15, Self = false, Duration = 1},
                new Effect {Id = 11, Name = "Endurance", Intensity = 15, Self = true, Duration = -1},
                new Effect {Id = 12, Name = "Weakness", Intensity = -15, Self = false, Duration = 1},
